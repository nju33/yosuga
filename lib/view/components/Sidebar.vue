<template>
  <div class="sidebar__box" ref="box" style="width:13em">
    <h1 class="title">
			<a v-if="opts.icon"><img :src="opts.icon" style="height:4em" :alt="opts.title || 'Yosuga'"></a>
			<a v-if="opts.title" class="title-link" :href="$router.options.base" v-text="opts.title || 'Yosuga'"></a>
		</h1>
